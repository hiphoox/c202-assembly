defmodule CodeGenerator do
  ...
  defp generate_raw_string_code(abstract_syntax_tree, incoming_free_context \\ 
    ...
    {children_string, children_context, free_context} = print_next_children(
      children_list, [], incoming_free_context, 0, start_string)

    {return_string, return_my_context, return_free_context} = contextualize_asm(
    ...
    if abstract_syntax_tree.token == nil do
      ...
      { children_string
        <> String.replace(return_string, ":t", abstract_syntax_tree.token.expression) 
        <> "\n", return_my_context, return_free_context
      }
    end
  end
  ...
  defp print_next_children(children_list, incoming_siblings_context, 
    ...
    {return_string, return_siblings_context, return_free_context} = 
      generate_raw_string_code(head, incoming_free_context, sibling_number, incoming_string)
    print_next_children(tail, return_siblings_context ++ incoming_siblings_context, 
